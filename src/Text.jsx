...
const Text = ({ name }) => {
  const notes = [
    <div>
      {name && <p className="invitee">Dear {name}</p>}
    ...
    <div>
      <h1>RSVP</h1>
      <p>
        Shelley: <a href="tel:07761901734">07761901734</a>
      </p>
      <p>
        James: <a href="tel:07814509239">07814509239</a>
      </p>
    </div>
  ];
        ...
        <animated.section
          ...
          style={{
            transform: x.interpolate(
              n =>
                `translate3d(0, ${100 * n}%, 0) rotate(${((index * 19) % 12) -
                  6}deg) scale(${1 + 0.3 * n})`
            )
          }}
        >
